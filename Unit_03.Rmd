...
knitr::include_graphics("images/unit3/Mikro_vs_Makro.png")
```

.quellePan[Bildquelle: [tumblr.com](https://econsociology.tumblr.com/post/105479023240)]
]
]
]
...
.pull-left[
```{r, echo=FALSE,out.width = "100%"}
knitr::include_url("images/unit3/skydiving_(pixabay)_tiny.png",height = "295px")
```
]
.pull-right[
.blockquote[
...
.pull-left[
```{r, echo=FALSE,out.width = "100%"}
knitr::include_url("images/unit3/robot_(pixabay)_small.png",height = "405px")
```
]
.pull-right[
...
```{r, echo=FALSE,out.width = "100%"}
knitr::include_url("https://www.core-econ.org/the-economy/book/text/03.html#figure-3-9i",height = "550px")
```
...
```{r, echo=FALSE,out.width = "100%"}
knitr::include_url("https://www.core-econ.org/the-economy/book/text/03.html#figure-3-10ag",height = "480px")
```
]
.panel[.panel-name[konstantes Grenzprodukt]
```{r, echo=FALSE,out.width = "100%"}
knitr::include_url("https://www.core-econ.org/the-economy/book/text/03.html#figure-3-15d",height = "480px")
```
]
]
...
```{r, echo=FALSE,out.width = "100%"}
knitr::include_url("https://www.core-econ.org/the-economy/book/images/web/figure-03-17.svg",height = "480px")
```
]
.panel[.panel-name[EE=0]
```{r, echo=FALSE,out.width = "100%"}
knitr::include_url("https://www.core-econ.org/the-economy/book/images/web/figure-03-18.svg",height = "480px")
```
]
.panel[.panel-name[EE<0]
...
```{r, echo=FALSE,out.width = "100%"}
knitr::include_url("https://www.core-econ.org/the-economy/book/text/03.html#figure-3-19bf",height = "550px")
```
...
```{r, echo=FALSE,out.width = "100%"}
knitr::include_url("https://www.core-econ.org/the-economy/book/text/03.html#figure-3-20e",height = "550px")
```
...
knitr::include_url('images/unit3/beverages_(pixabay).png',height = '460px')
```
...
knitr::include_url('images/unit3/shades_of_grey.png',height = '418px')
```
]
.pull-right[
...
```{r, echo=FALSE,out.width = "100%",fig.align='center'}
knitr::include_url('https://www.penguin.com.au/books/misbehaving-9780241951224',height = '450px')
```
]
]
...
<br>
<br>
vgl. dazu ausführlich Kapitel 18 in Goolsbee/Levitt/Syverson (2016).
...
* Makroökonomische Perspektive
   * Gesellschaften können Produktivitätssteigerungen unterschiedlich nutzen
      * Steigerung der Produktionsmenge
      * Verkürzung Arbeitszeit vs. "Befreiung" von Arbeit (für bestimmte Gruppen)
--
* Mikroökonomische Perspektive
   * Rational Choice erklärt, wie Produktivitätssteigerungen historische genutzt wurden
   * Kritik an der Rational Choice Theorie
      * Verhaltensökonomik
      * Dennoch: Konzeptioneller Wert (hier: EE vs. SE)
--
* Verhaltensökonomik
   * Reale Menschen verhalten sich nicht wie der homo oeconomicus
   * Dennoch kann Verhalten vorhergesagt werden
      * menschliches Verhalten ist "predictably irrational" (D. Ariely)
      * Hintergrund: Heuristiken erleichtern das Zurechtfinden in einer komplexen Welt
