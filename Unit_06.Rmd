...
# CORE Unit 6 (Unternehmen, Prinzipale und Agenten)
...
.pull-left[
```{r, echo=FALSE}
knitr::include_graphics('images/unit6/simon_(nobel.org).jpg')
```
]
...
.pull-left[
```{r, echo=FALSE}
knitr::include_graphics('images/unit6/coase_(nobel.org).jpg')
```
]
...
knitr::include_graphics('images/unit6/T-kosten_Phasen_(Felden_Hack_S111).PNG')
```

<br>

.quellePan[Quelle: Felden/Hack (2019, S. 111).]
]
.panel[.panel-name[Einflussfaktoren]
```{r, echo=FALSE,fig.align='center'}
knitr::include_graphics('images/unit6/T-kosten_Faktoren_(Felden_Hack_S112).PNG')
```

<br>

.quellePan[Quelle: Felden/Hack (2019, S. 112).]
]
]
...
knitr::include_graphics('images/unit6/NIE_(Williamson_2000)_small.png')
```
...
--
* Organisationen und Märkte unterscheiden sich auch in der Art der Beziehungen
  
    * Firmenspezifisches Kapital
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.core-econ.org/the-economy/book/images/web/figure-06-01-c.jpg',height='550px')
```
...
.pull-right[
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics('images/unit6/gewinnmaximierung.png')
```
...
* Großunternehmen
  * typischerweise viele Eigentümer (Anteilseigner)
    * Individuen und Institutionelle Investoren (Pensionskassen) 
    * die Mehrheit ist nicht in der Unternehmensführung
...
* Lösungsmöglichkeiten:
  ...
  * Überwachung (Monitoring) der Management-Leistung (Aufsichtsrat)
...
???
The dashed upward green arrows represent a problem of asymmetric information between levels in the firm’s hierarchy. 
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.core-econ.org/the-economy/book/images/web/figure-06-01-c.jpg',height='480px')
```
]
]
...
* Unter Anreizgesichtspunkten nicht: 
  ...
  * Höhere Anstellungsrente  $\Rightarrow$  höhere Kosten des Arbeitsplatzverlustes  $\Rightarrow$  höherer Anreiz zu hohem Arbeitseinsatz
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.core-econ.org/the-economy/book/images/web/figure-06-04-g.jpg',height='500px')
```
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.core-econ.org/the-economy/book/images/web/figure-06-05-e.jpg',height='480px')
```
]
.panel[.panel-name[Beste Antwort]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.core-econ.org/the-economy/book/images/web/figure-06-06-f.jpg',height='480px')
```
]
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.core-econ.org/the-economy/book/images/web/figure-06-07-d.jpg',height='420px')
```
...
```{r, echo=FALSE,fig.align='center',out.width='75%'}
knitr::include_graphics('images/unit6/Prinzipal-Agent_(Felden_Hack_S113).png')
```

Auswahl weiterer Beispiele (neben Arbeitgeber/-nehmer, Eigner/Manager)
