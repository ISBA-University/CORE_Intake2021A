...
# Aktuell: Ukraine-Krieg und Wohlstand

```{r, echo=FALSE,out.width = "100%"}
knitr::include_url("https://www.handelsblatt.com/meinung/gastbeitraege/gastkommentar-auch-in-deutschland-wird-der-wohlstand-infolge-der-geopolitischen-zaesur-sinken-/28111410.html",height = "550px")
```

.quelle[Quelle: [Handelsblatt](https://www.handelsblatt.com/meinung/gastbeitraege/gastkommentar-auch-in-deutschland-wird-der-wohlstand-infolge-der-geopolitischen-zaesur-sinken-/28111410.html).]
...
.blockquote[
1. Empirische Daten und Entwicklung von Forschungsfragen
...
---
name: Wohlstand&Verteilung
class: inverse, center, middle


# Einkommen und Wohlstand

.blockquote[Entwicklung]

.blockquote[Statistik: Messung und Darstellung]
...
knitr::include_graphics('images/unit1/GDP_DispInc_Corona_(Economist_20210718).png')
```
...
name: BIPstats
class: left
# Statistische Aspekte der Wohlstandsmessung
...
knitr::include_graphics('images/unit1/Wirtschaftsordnungen.png')
```
...
```{r, echo=FALSE,out.width = "100%"}
knitr::include_url("https://www.researchgate.net/profile/Charles-Edquist-2/publication/271074148/figure/tbl1/AS:668513236709376@1536397384073/Major-features-of-LME-and-CME_W640.jpg",height = "550px")
```

.quelle[Quelle: [Edquist (2012).](https://www.researchgate.net/publication/271074148_Knowledge-intensive_Entrepreneurship_National_Systems_of_Innovation_and_European_Varieties_of_Capitalism_A_Conceptual_Framework)]
...
knitr::include_graphics('images/unit13/Inequality_beyond_GDP.png')
```
