...
.blockquote[.small[
1. Wirtschaftskreislauf und Makroökonomische Aggregate
2. Inflation und Arbeitslosigkeit
3. Volkswirtschaftliche Gesamtrechnungen (VGR)
4. Konjunkturzyklus und die Rolle von Konsum und Investitionen
...
{\sffamily	
	\begin{tikzpicture}[scale=1.7]
			...
			\draw[blue!50,rounded corners=10,thick,shift={(-0.15,-0.15)},fill=blue!50]
			(3.75,1) rectangle (7,2.5) node[black,pos=.5] {{\huge \textbf{\textsf{Kapitalmarkt}}}};
		\end{tikzpicture}
```
]
]
...
* Dies sind:
     ...
     *  Finanzmärkte (Transformation von Einkommen in Kapital, Zinsen und Inflation)
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.core-econ.org/the-economy/book/images/web/figure-13-06.svg',height='550px')
```
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://trends.google.de/trends/explore?date=all&geo=DE&q=recession',height='550px')
```
...
<iframe src="https://ourworldindata.org/grapher/inflation-levels-and-volatility-in-high--and-low-income-economies-1960-2017" loading="lazy" style="width: 100%; height: 600px; border: 0px none;"></iframe>
]
]
...
```{r, echo=FALSE,out.width = "100%"}
knitr::include_url('https://www.core-econ.org/the-economy/book/images/web/figure-13-flowchart-01.svg',height='550px')
```
]
]
