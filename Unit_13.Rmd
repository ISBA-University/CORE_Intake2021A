...
.blockquote[.small[
1. Welche makroökonomischen Aggregate werden betrachtet, um den Wohlstand eines Landes zu beurteilen?
2. Welche Zusammenhänge bestehen zwischen diesen Aggregaten und warum schwanken sie?
...
4. Fähigkeiten-Ansatz und Wohlstandsmessung
]
]
...
{\sffamily	
	\begin{tikzpicture}[scale=1.7]
			...
			(0,2.75) rectangle (3.25,4.25) node[black,pos=.5] {{\huge \textbf{\textsf{Arbeitsmarkt}}}};
			\draw[blue!50,rounded corners=10,thick,shift={(-0.15,-0.15)},fill=blue!50]
			(3.75,2.75) rectangle (7,4.25) node[black,pos=.5] {{\huge \textbf{\textsf{Gütermarkt}}}};
			...
			\draw[blue!50,rounded corners=10,thick,shift={(-0.15,-0.15)},fill=blue!50]
			(3.75,1) rectangle (7,2.5) node[black,pos=.5] {{\huge \textbf{\textsf{(Finanz-)\\Kapitalmarkt}}}};
		\end{tikzpicture}
```
]
]
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('images/unit13/Eckwerte_Arbeitsmarkt_(Destatis_2022).png',height='480px')
```
.quellePan[Quelle: [Destatis (2022)](https://www.destatis.de/DE/Themen/Arbeit/Arbeitsmarkt/Erwerbstaetigkeit/Tabellen/eckwerttabelle.html).]
]
]
...
## Gütermarkt, Wachstum und wirtschaftliche Schwankungen

.blockquote[Gütermarkt und BIP]
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('images/unit13/VGR_small.png',height='480px')
```
.quellePan[Eigene Darstellung.]
]
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('images/unit13/BIP_2021.PNG',height='550px')
```
.quelle[Quelle: [Destatis (2022)](https://www.destatis.de/DE/Themen/Wirtschaft/Volkswirtschaftliche-Gesamtrechnungen-Inlandsprodukt/Publikationen/Downloads-Inlandsprodukt/zusammenhaenge-pdf-0310100.pdf).]
...
.panel[.panel-name[Aktuell]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics('images/unit13/Entstehung_2021_(Destatis_S11).png')
```
...
.panel[.panel-name[Historisch]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics('images/unit13/bpb_langeReihe_Entstehung_(Rahlf_2015).png')
```
.quellePan[Quelle: [Bundeszentrale für Politische Bildung (2015)](https://www.bpb.de/system/files/dokument_pdf/4938_zb_dtindaten_gesamt.pdf)]
...
.panel[.panel-name[Aktuell]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://service.destatis.de/DE/vgr-monitor-deutschland/bip.html',height='480px')
```
.quellePan[Quelle: [Destatis (2022)](https://www.dashboard-deutschland.de/#/themen/konjunktur_wirtschaft/preise).]
]
.panel[.panel-name[Historisch]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics('images/unit13/bpb_langeReihe_Nachfragekomponenten_(Rahlf_2015).png')
```
.quellePan[Quelle: [Bundeszentrale für Politische Bildung (2015)](https://www.bpb.de/system/files/dokument_pdf/4938_zb_dtindaten_gesamt.pdf)]
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics('images/unit13/Primaereinkommen_seit1991_(Destatis_2022).png')
```
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics('images/unit13/IGE_(ifo_2018).png')
```
...
```{r, echo=FALSE,fig.align='center'}
knitr::include_url('https://service.destatis.de/DE/vgr-monitor-deutschland/investitionen.html
',height='550px')
```
...
`r fa("arrow-alt-circle-right")` Ziel: Abbildung des (reinen) Mengeneffekts

`r fa("arrow-alt-circle-right")` Methodik: Vorjahrespreisbasis (seit VGR Revision 2005), vgl. [BIP-Deflator](#InfMess)
...
```{r, echo=FALSE,fig.align='center'}
knitr::include_graphics('images/unit13/Wachstumsraten_(destatis_2022_S10).png')
```


.quelle[[Statistisches Bundesamt (2022, S. 10)](https://www.destatis.de/DE/Themen/Wirtschaft/Volkswirtschaftliche-Gesamtrechnungen-Inlandsprodukt/Publikationen/Downloads-Inlandsprodukt/zusammenhaenge-pdf-0310100.pdf;jsessionid=9082E91CA5A2D0DAB3E72CBDA8DA25EA.live711?__blob=publicationFile)]
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('images/Covid_Kreislauf_(Baldwin_2020).png',height='480px')
```
...
.quelle[[Statistisches Bundesamt (2021/2022, S. 12)](https://www.destatis.de/DE/Themen/Wirtschaft/Volkswirtschaftliche-Gesamtrechnungen-Inlandsprodukt/Publikationen/Downloads-Inlandsprodukt/zusammenhaenge-pdf-0310100.pdf?__blob=publicationFile&v=6)]
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.core-econ.org/the-economy/book/images/web/figure-10-04-a.svg
',height='480px')
```
]
.panel[.panel-name[Lebenszyklusprofil]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.core-econ.org/the-economy/book/images/web/figure-13-10-c.svg
',height='480px')
```
]
.panel[.panel-name[Schock]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.core-econ.org/the-economy/book/images/web/figure-13-12-f.svg
',height='480px')
```
]
]
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.core-econ.org/the-economy/book/images/web/figure-13-11-c.svg
',height='480px')
```
]
.panel[.panel-name[Disziplin]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.core-econ.org/the-economy/book/images/web/figure-13-13-c.svg
',height='480px')
```
]
]
...
.blockquote[Inflationsbegriff]

.blockquote[Inflationsmessung]
...
* Obs! **Den** Geldwert gibt es nicht (`r fa("arrow-alt-circle-right")` [individueller Verwendungszweck](#PersInf)).
...
```
.quellePan[Quelle: [Börsen-Zeitung (14.09.2021).](https://www.boersen-zeitung.de/konjunktur-politik/debatte-ueber-drohende-stagflation-91da2e80-1483-11ec-9992-c879d4511d99).]
]
...
.panel[.panel-name[Aktuell]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.dashboard-deutschland.de/#/themen/konjunktur_wirtschaft/preise',height='480px')
```
.quellePan[Quelle: [Destatis (2022)](https://www.dashboard-deutschland.de/#/themen/konjunktur_wirtschaft/preise).]
]
.panel[.panel-name[Historisch]
...
Inflation als Anstieg des Preisniveaus: Durchschnitt aller Güterpreise
...
.quellePan[Quelle: [Weichenrieder/Gürer (2020)](https://www.wirtschaftsdienst.eu/inhalt/jahr/2020/heft/11/beitrag/inflation-inflationsmessung-und-zentralbankpolitik.html).]
]
...
* BIP-Deflator vs. VPI
  * BIP-Deflator - Preise der im Inland **produzierten** Güter
  * VPI - Preise der im Inlande **konsumierten** Güter
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.iwkoeln.de/fileadmin/user_upload/Presse/IW-Nachrichten/Inflation_1.png',height='480px')
```
]
.panel[.panel-name[Strom]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.iwkoeln.de/fileadmin/user_upload/Presse/IW-Nachrichten/Inflation_2.png',height='480px')
```
]
]
...
.panel[.panel-name[Übersicht]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('images/unit13/Ursachen_Inflation_small.png',height='480px')
```
.quellePan[Eigene Darstellung.]
]
.panel[.panel-name[Quantitätstheorie]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('images/unit13/QTheory.png',height='480px')
```
.quellePan[Quelle: [Bauman (2011, S. 48)](https://www.amazon.de/dp/0809033615/ref=cm_sw_em_r_mt_dp_5WNEX8X23YD4AVNFM9Y9).]
]
]
...
# Arbeitsmarkt und Inflation: die Phillips-Kurve
...
```
.quellePan[Quelle: Issing (2011, S. 227).]
]
...
```
.quellePan[[CORE - The Economy (Unit 15)](https://www.core-econ.org/the-economy/book/text/15.html#153-inflation-the-business-cycle-and-the-phillips-curve).]
]
.panel[.panel-name[Modifikation]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('images/unit13/phillips_mod_(Issing_S229).png',height='480px')
```
.quellePan[Quelle: Issing (2011, S. 229).]
]
