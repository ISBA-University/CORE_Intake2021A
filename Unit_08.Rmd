...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('images/unit8/xetra_auktionsplan.png',height='480px')
```
.quellePan[[Börse Frankfurt](https://www.xetra.com/xetra-de/handel/handelsmodelle/auktionsplan)]

]

.panel[.panel-name[Individuell]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('images/unit8/inlandsorder_comdirect.png',height='480px')
```
]
.panel[.panel-name[Orderbuch]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('images/unit8/offenes_Orderbuch_(20200420).png',height='480px')
```
.quellePan[[Börse Frankfurt](https://www.boerse-frankfurt.de/aktien/offenes-orderbuch/DE0008469008)]
]
.panel[.panel-name[Diagramm]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('images/unit8/AT-NE_Bofinger_S46.png',height='480px')
```
]
]
