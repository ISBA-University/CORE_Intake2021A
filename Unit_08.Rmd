...
* Annahmen
    ...
    * vollständige Information (Preise und Qualitäten bekannt) bzw. vollständige Verträge (impliziert *homogene Güter*)
...
<iframe width="1000" height="500" src="https://www.youtube.com/embed/r7vzgexzXOk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.core-econ.org/the-economy/book/images/web/figure-08-10-a.svg',height='550px')
```

]
.panel[.panel-name[Quinoa-Nachfrage]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.core-econ.org/the-economy/book/images/web/figure-08-10-c.svg',height='550px')
```
]
.panel[.panel-name[Modell]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.core-econ.org/the-economy/book/images/web/figure-08-11-d.svg',height='550px')
```
]
]
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.core-econ.org/the-economy/book/images/web/figure-08-13.svg',height='550px')
```
]
.panel[.panel-name[Beispiel]
...
.panelset[
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.core-econ.org/the-economy/book/images/web/figure-08-17.svg',height='470px')
```
]
]
