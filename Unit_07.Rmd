...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('images/unit7/Branchenstruktur_5forces.svg',height='470px')
```

.quellePan[Bildquelle: [Wikipedia](https://de.wikipedia.org/wiki/Wettbewerbsstrategie#/media/Datei:Wettbewerbsstrategien_Michael_E._Porter.svg).]
]
.panel[.panel-name[Strategien]
.center[
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('images/unit7/Wettbewerbsstrategien_Porter.svg',height='470px')
```
]
.quellePan[Bildquelle: [Wikipedia](https://de.wikipedia.org/wiki/Wettbewerbsstrategie#/media/Datei:Wettbewerbsstrategien_Michael_E._Porter.svg).]
]
...
<iframe src="images/unit7/decisions.png" style="width: 100%; height: 550px; border: 0px none; margin-left: 100px"></iframe>
...
```{r, echo=FALSE}
knitr::include_url('images/unit7/Isoquanten.png',height = '490px')
```
]
]
...
$$TC=\underbrace{w\cdot L}_{\mbox{Arbeitskosten}}+\underbrace{r\cdot K}_{\mbox{Arbeitskosten}}$$
...
%		\node [black,left] at (0,\y) {\scriptsize\y};
		...
		%GRTS 	
			\draw [color=red][domain=15:35] plot (\x,{240-4.8*\x}) node [font=\tiny,left] {$\mbox{GRTS}_A$};
			\draw [color=red][domain=50:140] plot (\x,{60-0.3*\x}) node [font=\tiny,below] {$\mbox{GRTS}_B$};
...
```{r, echo=FALSE}
knitr::include_url('images/unit7/Expansion_SR_LR_(Goolsbee_S267).PNG',height = '490px')
```

.quellePan[Quelle: Goolsbee et al (2016, S. 267).]
]
.panel[.panel-name[Kostenfunktionen]
```{r, echo=FALSE}
knitr::include_url('images/unit7/TC_SR_LR_(Goolsbee_S268).PNG',height = '490px')
```

.quellePan[Quelle: Goolsbee et al (2016, S. 268).]
]
]
...
',height='480px')
```
.quellePan[Quelle: [guides.co](https://guides.co/g/the-network-effects-bible/121725)]
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('images/unit7/ViralNFX-Chart.png',height='470px')
```
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('images/unit7/NE_agg.png',height='550px')
```
]
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('images/unit7/Gewinne_(Stocker).PNG',height='470px')
```
.quellePan[Quelle: Stocker (2007, S. 7).]
]
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.core-econ.org/the-economy/book/images/web/figure-07-04-f.svg
',height='470px')
```
]
.panel[.panel-name[...steigenden MC]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.core-econ.org/the-economy/book/images/web/figure-07-10-a.svg
',height='470px')
```
]
]
...
$$\mbox{slope of isoprofit curve}=-\frac{(P-MC)}{Q}=\frac{\mbox{profit margin}{\mbox{Menge}}$$
* Ausgangspunkt G
  * Erhöhung der Ausbringungsmenge um 1 nur möglich, wenn der Preis um (P-MC)/Q (=Steigung der Isoprofitkurve) sinkt (implizit in der Isogewinnlinie)
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.core-econ.org/the-economy/book/images/web/figure-07-12-b-i.svg
',height='470px')
```
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.core-econ.org/the-economy/book/images/web/figure-07-16.svg
',height='470px')
```
]
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url('https://www.toyota.de/automobile/prius-plugin/',height='470px')
```
]
.panel[.panel-name[Werbung]
 ...
 * Wohlfahrt = Konsumentenrente (KR) + Produzentenrente (PR)
    * maximal im Konkurrenzmarkt (Preis ist für Anbieter ein Datum $\implies$ p=MC)
